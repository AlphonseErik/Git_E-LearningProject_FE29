...
function GetUserList(props) {
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, props.userDetail.length - page * rowsPerPage);
    ...
    return (
        <TableContainer component={Paper}>
            ...
            <Table className={classes.table}>
                ...
                <TableBody>
                    {(rowsPerPage > 0 ? props.userDetail.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : props.userDetail).map((item, index) => (
                        <TableRow key={index}>
                            <TableCell className="text-center">{item.taiKhoan}</TableCell >
